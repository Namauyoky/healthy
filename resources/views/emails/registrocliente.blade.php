                            ...
                            {{--<table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">--}}
                                {{--<tr style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">--}}
                                    {{--<td class="content-block" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">--}}
                                        {{--<strong>De : </strong> Jorge--}}
                                    {{--</td>--}}
                                {{--</tr>--}}
                                {{--<tr style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">--}}
                                    {{--<td class="content-block" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">--}}
                                        {{--<strong>Asunto : </strong> Jorge--}}
                                    {{--</td>--}}
                                {{--</tr>--}}
                                {{--<tr style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">--}}
                                    {{--<td class="content-block" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">--}}
                                        {{--Bienvenido  su Nip es--}}
                                    {{--</td>--}}
                                {{--</tr>--}}
                            {{--</table>--}}
                        {{--</td>--}}
...
<p><strong><i> Bienvenido ahora es un Nuevo Distribuidor de Healthy People Co.</i></strong></p>
<p><center><img src="http://www.healthypeopleco.com/img/logotipo.png" alt="Registro" width="30%" height="30%"/></center></p><br><center>Su Registro ha sido Procesado y sus Datos de Afiliación son los Siguientes:</center></p>
<p><center> Nombre: {{ $nombre_completo  }} <br>N&uacute;mero de Afiliado: {{ $Id_Afiliado }} <br> Nip: {{ $Nip  }} <br> Patrocinador: {{ $Id_Cliente_Patrocinador }} <br></center></p>
